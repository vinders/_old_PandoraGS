...
bool     Config::rnd_isDebugMode;     // vram/status diplay (on/off)
...
timemode_t Config::sync_timeMode;      // type of timer
// miscellaneous
bool Config::misc_isScreensaverDisabled;   // disable screensaver
char Config::misc_gpuKeys[CTRLKEYS_LENGTH]; // plugin key bindings
...
void Config::init()
{
    ...
    misc_gpuKeys[CTRLKEYS_LENGTH - 1] = '\0';
    setDefaultValues();
}
...
{
    misc_gpuKeys[(int)Ctrlkey_menuToggle] = VK_INSERT;
    misc_gpuKeys[(int)Ctrlkey_menuPrev] = VK_PRIOR;
    misc_gpuKeys[(int)Ctrlkey_menuNext] = VK_NEXT;
    misc_gpuKeys[(int)Ctrlkey_menuDefault] = VK_HOME;
    misc_gpuKeys[(int)Ctrlkey_menuAccept] = VK_END;

    misc_gpuKeys[(int)Ctrlkey_ratioMode] = VK_F11;
    misc_gpuKeys[(int)Ctrlkey_fastForward] = VK_NOKEY;
    misc_gpuKeys[(int)Ctrlkey_slowMotion] = VK_NOKEY;
    misc_gpuKeys[(int)Ctrlkey_fps] = VK_F12;
    misc_gpuKeys[(int)Ctrlkey_pause] = VK_NOKEY;
}
