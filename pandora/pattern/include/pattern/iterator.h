...
#define _P_ITERATOR_MEMBERS(collectionType, valueType, category, firstPtr) \
        using iterator = pandora::pattern::Iterator<collectionType, valueType, false, false, category, valueType>; \
        using const_iterator = pandora::pattern::Iterator<collectionType, valueType, true, false, category, valueType>; \
...
#define _P_REVERSE_ITERATOR_MEMBERS(collectionType, valueType, category, lastPtr) \
        using reverse_iterator = pandora::pattern::Iterator<collectionType, valueType, false, true, category, valueType>; \
        using const_reverse_iterator = pandora::pattern::Iterator<collectionType, valueType, true, true, category, valueType>; \
