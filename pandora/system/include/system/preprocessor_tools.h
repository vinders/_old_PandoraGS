...
License :     GPLv2
--------------------------------------------------------------------------------
Macros : _P_EXPAND, _P_EXPAND_COMMA, _P_EXPAND_SEMICOLON,
         _P_STRINGIFY, _P_STRINGIFY_COMMA, _P_STRINGIFY_SEMICOLON,
         _P_GET_ARG_COUNT, _P_GET_FIRST_ARG, _P_DROP_FIRST_ARG, _P_LIST_ENUM_VALUES,
         _P_FOREACH, _P_PARAM_FOREACH, _P_SERIALIZABLE_ENUM, _P_FLAGS_OPERATORS
