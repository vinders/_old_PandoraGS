...
#       elif defined(__GNUC__) && __GNUC__ <= 9
          ...
          auto timePoint = std::chrono::time_point_cast<std::chrono::system_clock::duration>(entry.last_write_time(errorCode) - std::filesystem::file_time_type::clock::now() + system_clock::now());
