...
#   if defined(_WINDOWS) || defined(WIN32) || defined(_WIN32) || defined(_WIN64) || defined(_WINNT)
      ...
      private:
        static constexpr inline std::chrono::milliseconds _defaultSystemPeriod() { return std::chrono::milliseconds(16); }
...
#     if defined(__MACH__) && !defined(CLOCK_MONOTONIC)
        ...
        private:
          ...
          static constexpr inline double _defaultSystemPeriod() { return 1000000.0; }
        };
