...
class LangConfigDE : public LangConfig
{
    public:
    LangConfigDE()
    {
        ...
        buttonOK     = _T("OK");
        buttonCancel = _T("Abbrechen");
        
        pageGeneralSettings = _T("General settings");           // pages
        pageProfilesManager = _T("Profiles manager");
        ...
        pageManGroupProfilesManage = _T("Profiles management"); // page2 labels
        ...
        pageProMdecFilter       = _T("MDEC movie filter");
        ...
        cfgTextureUpscaling2 = _T("2x Super-Eagle upscaling");
        ...
        cfgSpriteUpscaling2 = _T("2x Super-Eagle upscaling");
        ...
        cfgInternalResY5 = _T("Y: Ultra+ (8x, very slow)");
...
/* INGAME MENU CONTENT ------------------------------------------------------ */
class LangMenuDE : public LangMenu
{
    public:
    LangMenuDE()
    {
