...
namespace config
{
    ...
    public:
        ...
        /// @param[in] key         Key path
        /// @param[in] accessMode  IO mode
        bool open(const std::wstring path, const registry_io_mode_t accessMode = registry_io_mode_t::read)
        {
        ...
        /// @returns Success
        static bool remove(std::wstring path, const std::wstring& keyName);
        ...
        /// @param[out] outIntVal  Output value
        void read(const std::string& key, uint32_t& outIntVal);
        ...
        void read(const wchar_t* key, char* outStringVal, const size_t length);
    ...
    public:
        ...
        inline void writeBool(const wchar_t* key, const bool val)
        {
        ...
        /// @param[in] key  Registry key item
        /// @param[in] val  Written value
        template<class T> inline void writeBoolType(const wchar_t* key, const T val, const T falseBoolVal)
        {
        ...
        /// @param[in] key  Registry key item
        /// @param[in] val  Written value
        inline void writeInt(const wchar_t* key, const uint32_t val)
        {
            m_regBuffer = val;
            ::RegSetValueEx(m_regKey, (LPCWSTR)key, 0, REG_DWORD, (LPBYTE)&m_regBuffer, sizeof(val));
        }
        ...
        /// @param[in] key  Registry key item
        /// @param[in] val  Written value
        template<class T> inline void writeIntType(const wchar_t* key, const T val)
        {
        ...
        /// @param[in] key  Registry key item
        /// @param[in] val  Written value
        void writeInt(const std::string& key, const uint32_t val);
        /// @brief Write float value
        /// @param[in] key  Registry key item
        /// @param[in] val  Written value
        ...
        void writeString(const wchar_t* key, const char* val, const size_t length);
        /// @brief Write standard string value
        /// @param[in] key  Registry key item
        /// @param[in] val  Written value
        void writeString(const wchar_t* key, const std::string& val);
        /// @brief Write wide string value
        /// @param[in] key  Registry key item
        /// @param[in] val  Written value
        void writeString(const wchar_t* key, const std::wstring& val);
    ...
    public:
        ...
        bool open(const std::wstring path, const file_io_mode_t fileMode = file_io_mode_t::read);
        /// @brief Close data source
        void close();
        ...
        /// @returns Success
        static bool remove(std::wstring path, const std::wstring& fileName);
    private:
    ...
    public:
        ...
        /// @param[in] key  File entry
        /// @param[in] val  Written value
        void writeBool(const wchar_t* key, const bool val);
        /// @brief Write boolean-typed enum value
        /// @param[in] key  File entry
        /// @param[in] val  Written value
        template<class T> inline void writeBoolType(const wchar_t* key, const T val)
        {
        ...
        /// @param[in] key  File entry
        /// @param[in] val  Written value
        void writeInt(const wchar_t* key, const uint32_t val);
        /// @brief Write integer-typed enum value
        /// @param[in] key  File entry
        /// @param[in] val  Written value
        template<class T> inline void writeIntType(const wchar_t* key, const T val)
        ...
        /// @param[in] key  Registry key item
        /// @param[in] val  Written value
        void writeInt(std::string& key, const uint32_t val);
        /// @brief Write float value
        /// @param[in] key  File entry
        /// @param[in] val  Written value
        void writeFloat(const wchar_t* key, float val);
    ...
    private:
        ...
        /// @param[in] key  File entry
        /// @param[in] val  Written value
        inline void appendValue(const wchar_t* key, const std::wstring& val)
        {
            std::wstring valStr = std::wstring(key) + L";"s + val + L"\n"s;
            m_file.write(valStr.c_str(), valStr.size());
        }
        /// @brief Write value at the end of the file
        /// @param[in] key  File entry
        /// @param[in] val  Written value
        inline void appendValue(const std::wstring& key, const std::wstring& val)
        {
            std::wstring valStr = key + L";"s + val + L"\n"s;
            m_file.write(valStr.c_str(), valStr.size());
        }
    };
    ...
    template<typename T>
    bool isEmptyValue(const T& val);
    template<> inline bool isEmptyValue<uint32_t>(const uint32_t& val)
    {
        return (val == 0u);
    }
    template<> inline bool isEmptyValue<std::wstring>(const std::wstring& val)
    {
        return (val.empty());
    }
